...
; Now modified by the mad man, Mad Scientist Moses.
...
SavedJoypadBitsPrevious   = $0724
JumpNextLevelFlag = $076c
JumpNextLevelFlagReloadPalette = $07Cf
...
.if SpeedMode == 1
ChangeAreaTimerMaxMed = $05
ChangeAreaTimerMaxFast = $05
ChangeAreaTimerMaxSlow = $05
.else
ChangeAreaTimerMaxMed = $34
ChangeAreaTimerMaxFast = $30
ChangeAreaTimerMaxSlow = $a0
.endif
...
VRAM_AddrTable_Low:
      ...
      .db <UndergroundPaletteData, <CastlePaletteData, <VRAM_Buffer1_Offset
      .db <VRAM_Buffer2, <VRAM_Buffer2, <BowserPaletteData
      .db <SandyPaletteData, <SnowPaletteData, <MushroomPaletteData
      .db <MarioThanksMessage, <LuigiThanksMessage, <MushroomRetainerSaved
      .db <PrincessSaved1, <PrincessSaved2, <WorldSelectMessage1
      .db <WorldSelectMessage2, <FallPaletteData, <DarkRockPaletteData
      .db <NormalPaletteData
...
NormalPaletteDataNumber = $15
MushroomPaletteDataNumber = $0b
SandyPaletteDataNumber = $09
SnowPaletteDataNumber = $0a
FallPaletteDataNumber = $13
DarkRockPaletteDataNumber = $14
...
PlayerEndWorld:
               ...
               bne EndExitTwo             ;branch to leave if not
...
FloateyNumbersRoutine:
              ...
              beq EndExitTwo               ;if zero, branch to leave
...
SetupIntermediate:
      lda BackgroundCurrent
      pha
      lda #$0f ;black
      sta BackgroundCurrent
...
PlayerColors:
      .db $16, $27, $18 ;mario's colors
      .db $30, $27, $19 ;luigi's colors
      .db $37, $27, $16 ;fiery (used by both)


.if FancyNewBackground == 0
      LoadPaletteModifier:
           ldy BackgroundColorCtrl   ;check background color control
           beq LoadPaletteModifierFinish  ;if not set, increment task and fetch palette
      ...
      LoadPaletteModifierFinish:
           rts
.else
      WorldPalettes:
            .db NormalPaletteDataNumber ; world 1 normal
            .db SandyPaletteDataNumber ; world 2 ocean
            .db SnowPaletteDataNumber ; world 3 snow
            .db FallPaletteDataNumber ; world 4 fall morning
            .db SnowPaletteDataNumber ; world 5 day snow
            .db DarkRockPaletteDataNumber; world 6 darkest night
            .db NormalPaletteDataNumber; world 7 final normal
            .db DarkRockPaletteDataNumber; world 8 hell

      LoadPaletteModifier:
            ldy AreaType             ;select appropriate palette to load
            cpy #$01
            bne LoadPaletteModifierCancel
            ldy WorldNumber
            ldx WorldPalettes,y
            stx VRAM_Buffer_AddrCtrl ;store offset into buffer control
            LoadPaletteModifierCancel:
                  rts
.endif


GetBackgroundColor:
           jsr LoadPaletteModifier       
            jsr LoadAreaBackgroundColor
            lda BackgroundGoal
            sta BackgroundCurrent
...
.if FancyNewBackground == 1
BackgroundColorsByWorld:
      .db $22 ; World one - sky blue
      .db $21 ; World two - beach bright sky
      .db $0c ; World three - night
      .db $37 ; World four - light orange morning
      .db $3C ; World five - snowy cloudy day
      .db $0f ; World six - night
      .db $21 ; Alt World seven - lighter blue
      ;.db $1c ; Alt. World Eight - Ominous Storm Sky
      ;.db $26 ; World seven - looming red sky
      .db $06 ; World eight - firey sky
.endif

LoadAreaBackgroundColor:
      .if FancyNewBackground == 1
            ;ldy BackgroundColorCtrl   ;check background color control
            ;tya
            ;bne GetBackgroundColorFinish             ;if not set, increment task and fetch palette
      GetBackgroundColorFromArea:
            ldy AreaType
            cpy #$02
            bcc LoadAreaBackgroundColorByWorld ;water and ground areas get world color
      GetBackgroundColorFinish: 
            lda BackgroundColors,y  ;put appropriate palette into vram
            jmp LoadAreaBackgroundColorComplete
      LoadAreaBackgroundColorByWorld:
            ldy WorldNumber
            lda BackgroundColorsByWorld,y  ;put appropriate palette into vram
      LoadAreaBackgroundColorComplete:
            sta BackgroundGoal
            rts
      .else
            ldy BackgroundColorCtrl  ;if this value is four or greater, it will be set
            bne SetBGColor2           ;therefore use it as offset to background color
...
UpdateBackgroundColor:
      ldx VRAM_Buffer1_Offset  ;get current buffer offset
            cpx #($3F-4)
            bcs UpdateBackgroundColorQuit         ;if not enough space, skip
      lda #$3f                 ;set for sprite palette address
      sta VRAM_Buffer1,x       ;save to buffer
      lda #$10
      sta VRAM_Buffer1+1,x
      lda #$01                 ;only one; so wasteful I know
      sta VRAM_Buffer1+2,x
      lda BackgroundCurrent
      sta VRAM_Buffer1+3,x
      lda #$00                 ;now the null terminator
      sta VRAM_Buffer1+4,x
      txa                      ;move the buffer pointer ahead 5 bytes
      clc                      ;in case we want to write anything else later
      adc #$05
      sta VRAM_Buffer1_Offset  ;store as new vram buffer offset
UpdateBackgroundColorQuit:
      rts

;---------------- New background color stuff--------------------
StepColorSubCurrentColor = BackgroundCurrent
StepColorSubGoalColor = BackgroundGoal
StepColorSubTemp = $00
AdvanceBackgroundColor:
StepColorSub:
      lda StepColorSubGoalColor
      cmp StepColorSubCurrentColor
      bne StepColorSubCalc 
      rts
StepColorSubCalc:
      cmp #$0f
      bne StepColorSubGoalNotBlack
            ;goal is black, we shall darken then black
            lda StepColorSubCurrentColor
            and #$30
            bne StepColorSubGoalDarken
                  lda #$0f
                  jmp StepColorSubFinish
            StepColorSubGoalDarken:
                  lda StepColorSubCurrentColor
                  clc
                  sbc #$0F
                  jmp StepColorSubFinish
      StepColorSubGoalNotBlack:
            ;goal is a color normal color
            lda StepColorSubCurrentColor
            cmp #$0F
            bne StepColorSubCurrentNotBlack
                  ; Current color is black
                  lda StepColorSubGoalColor
                  and #$0F
                  jmp StepColorSubFinish
            StepColorSubCurrentNotBlack:
            and #$0F
            bne StepColorSubCurrentIsOtherColor
                  ; Current color is white or gray
                  lda StepColorSubGoalColor ; combine with goal hue
                  and #$0F
                  jmp CombineAHueAndBrightness
            StepColorSubCurrentIsOtherColor:
                  lda StepColorSubGoalColor
                  and #$0F
                  sta StepColorSubTemp ; store goal hue
                  lda StepColorSubCurrentColor ; get current hue
                  and #$0F
                  cmp StepColorSubTemp ; compare to goal hue
                  beq StepColorSubSameHue
                  bcc StepColorHueSmaller
                        clc
                        sbc #$01
                        jmp CombineAHueAndBrightness
                  StepColorHueSmaller:
                        ...
                        jmp CombineAHueAndBrightness
                  StepColorSubSameHue:
                        lda StepColorSubCurrentColor ; get current brightness
                        cmp StepColorSubGoalColor ; compare to goal brightness
                        bcc StepColorBrightnessSmaller
                              clc
                              sbc #$0f
                              jmp CombineABrightnessAndHue
                        StepColorBrightnessSmaller:
                              clc
                              adc #$0f
                              jmp CombineABrightnessAndHue
                        jmp StepColorSubFinish
      CombineAHueAndBrightness:
            sta StepColorSubTemp
            lda StepColorSubCurrentColor
            and #$30
            ora StepColorSubTemp
            jmp StepColorSubFinish
      CombineABrightnessAndHue:
            and #$30
            sta StepColorSubTemp
            lda StepColorSubCurrentColor
            and #$0F
            ...
            jmp StepColorSubFinish
StepColorSubFinish:
      sta StepColorSubCurrentColor
      jmp UpdateBackgroundColor
...
DrawTitleScreen:
            ...
            .if ScoreReplacementMode == ScoreReplacementModeLives
                  bne DrawLivesInsteadOfTitle            ;if not, exit
            .else
...
GetLivesDigits:
      ...
      pha
            ...
            lsr
            lsr
      sta $01       ;the number of lives divided by ten
            asl
            asl
            asl
            sta $00 ;multiply by 8 and store for later
      pla
            ; mod A by ten by taking current and subtracting x8 and x2
            sec
            sbc $00
            pha
...
GroundPaletteData:
  .db $3f, $01, $0F
  .db      $29, $1a, $0f ; background palette
  .db $0f, $36, $17, $0f ; main brick colors: pale red, red, black
  .db $0f, $30, $21, $0f ; white, sky blue, black
  .db $0f, $27, $17, $0f ; orange, dark red-orange, black
  .db $3f, $15, $0B
  .db      $1a, $30, $27
  .db $0f, $16, $30, $27
  .db $0f, $0f, $36, $17
...
GroundPaletteData:
  .db $3f, $09, $07
  .db      $30, $21, $0f ; white, sky blue, black
  .db $0f, $27, $17, $0f ; orange, dark red-orange, black
  .db $3f, $15, $0B
  .db      $1a, $30, $27
  .db $0f, $16, $30, $27
...
.else
      ...
      .db $3f, $01, $07
      .db      $29, $1a, $0f ; background palette
      .db $0f, $30, $37, $0f ; main brick colors - sandy
      .db $00

      SnowPaletteData:
      .db $3f, $01, $07
      .db      $30, $00, $10
      .db $0f, $3c, $2c, $0f ; main brick colors, snowy
      .db $00

      FallPaletteData:
      .db $3f, $01, $07
      .db      $1b, $0b, $0f ; yellow background objects
      .db $0f, $35, $15, $0f ; main brick colors - slightly purple
      .db $00
...
StatusBarData:
      .if ScoreReplacementMode == ScoreReplacementModeTime
      .db $f1, $06 ; top score display on title screen
      .db $63, $06 ; player time total
      .db $63, $06
      .elseif ScoreReplacementMode == ScoreReplacementModeScore
      .db $f0, $06 ; top time display on title screen
      .db $62, $06 ; player time
      .db $62, $06
      .elseif ScoreReplacementMode == ScoreReplacementModeLives
      .db $f5, $02 ; top time display on title screen
      .db $67, $02 ; player time
      .db $67, $02
      .else
...
PrimaryGameSetup:
      ...
      lda #StartPlayerStatus
      sta PlayerStatus              ;set player's size to small
      lda #StartLives
...
SetStPos: lda PlayerStarting_X_Pos,y  ;load appropriate horizontal position
          ...
          sta Player_Y_Position       ;or value that overwrote $0710 as offset for vertical
            ...
            ; Downwards launch start hack
            .if UseDownwardsLaunchOnEntrance > 0
                  cmp #$30
                  bcs SkipDownLaunch
                  lda #$04
                  sta Player_Y_Speed
...
PlayerLoseLife:
             ...
             rts
StillInGame: 
            ; This new block patches a trick for skipping to the halfway page 
            lda ScreenLeft_PageLoc
            cmp #$F8
            bcc LookAtHalfwayPage
            lda #$00
            jmp SetHalfway
LookAtHalfwayPage:
...
ContinueGame:
           ...
           lda #StartPlayerSize                  ;actual world and area numbers, then
...
IncrementColumnPos:
           ...
           jsr CheckJumpNextLevel   ;Jump to the next level if the flag is set
...
StrBlock: ldy $00                    ;get offset for block buffer
          ...
          cpx #$0d
          bcc ChkMTLow               ;continue until we pass last row,ScreenLeft_PageLoc then leave
          rts
...
;-------------------------------------------------------------------------------------
; Hack by MadSciMo here
PressSelectToJumpNext:
      lda SavedJoypadBits
      eor SavedJoypadBitsPrevious ; get changed bits
      and SavedJoypadBits; get only just pressed bits
      and #Select_Button
      beq PressSelectToJumpNextQuit
      inc JumpNextLevelFlag
PressSelectToJumpNextQuit:
      rts
CheckJumpNextLevel:
      lda JumpNextLevelFlag
      beq CheckJumpNextLevelQuit
      ...
      jmp JumpNextLevel
CheckJumpNextLevelQuit:
      rts

AddressesToDecrementLow:
...
JumpNextLevel:
      ...
      sta AreaObjOffsetBuffer     ;set area object lengths for all empty
      sta AreaObjOffsetBuffer+1
      sta AreaObjOffsetBuffer+2
      ...
      ;palette fixing
      lda #$04
      sta JumpNextLevelFlagReloadPalette
      ...
      ;hard mode
      lda PrimaryHardMode      ;check to see if primary hard mode has been activated
      bne JNLSetSecHard           ;if so, activate the secondary no matter where we're at
      lda WorldNumber          ;otherwise check world number
      cmp #World5              ;if less than 5, do not activate secondary
      bcc JNLSkipHardMode
      bne JNLSetSecHard           ;if not equal to, then world > 5, thus activate
      lda LevelNumber          ;otherwise, world 5, so check level number
      cmp #Level3              ;if 1 or 2, do not set secondary hard mode flag
      bcc JNLSkipHardMode
JNLSetSecHard:    inc SecondaryHardMode    ;set secondary hard mode flag for areas 5-3 and beyond
JNLSkipHardMode:

      ;fix swim state; maybe not needed?
      ldy #$00
          lda AreaType                ;check area type
          bne ChkStPos2                ;if water type, set swimming flag, otherwise do not set
          iny
ChkStPos2: sty SwimmingFlag
...
Chk1stB:  ldx #$10                   ;load offset of 16 for special row 15
          ...
          cmp #$fd
          beq OnOutOfArea              ;if end of level, leave this routine
...
Alter2:  
      pla
      pha
      and #%00100000 ; if d5 set, we're gonna pull an area type switcharoo
      bne Alter3
...
FlagpoleObject:
      ; No longer render flagpoles; waste of space since they don't exist anymroe
      rts
...
;AREA OBJECT DATA
.MACRO castleEnding
      .hex ee85 ;drop ceiling low
      .hex fe01 ;remove ceiling
      .if UseNiceCastleTransition > 0
            .db $0e, %11100001 ;switch to standard ground level tileset
      .endif
.ENDM
.MACRO extraToStopAreaLoad
      .hex 7084 7084 ;two blocks on new pages; push stuff back
.ENDM

;level 1-4/6-4
L_CastleArea1:
      .db $93, $03
      ;.db %10010011‬, %00000011
      .db $03, $33, $5f, $32, $7e, $07, $ce, $03, $dc, $51
...
L_CastleArea2:
      .db $53, $03
      ;.db %01010011, %00000011
      .db $03, $33, $3f, $32, $5e, $0a, $68, $64
...
L_CastleArea3:
      .db $93, $03
      ;.db %10010011‬, %00000011
      .db $03, $33, $5f, $32, $7e, $07, $fe, $00, $27, $b1
...
L_CastleArea4:
      .db $93, $03
      ;.db %10010011‬, %00000011
      .db $03, $33, $5f, $32, $7e, $07, $fe, $06, $0c, $81
...
L_CastleArea5:
      .db $53, $03
      ;.db %01010011‬, %00000011
      .db $03, $33, $5f, $32, $7e, $07, $fe, $0a, $ae, $86
...
L_GroundArea10:
      .db $38, $11
      .db $0f, $26, $ad, $40, $ee, $00, $1e, $80;, $3d, $c7
      .extraToStopAreaLoad
      .db $fd
...
SaveAB:       lda A_B_Buttons            ;save current A and B button
            ...
            ;Reload level palette if flag set
            lda JumpNextLevelFlagReloadPalette
            beq UpdScrollVar
            dec JumpNextLevelFlagReloadPalette
            cmp #$01
                  beq UpdWorldNumber
            cmp #$02
                  beq UpdBackCol2
...
RunParser:    jsr AreaParserTaskHandler  ;update the name table with more level graphi
...
ScrollScreen:
              ...
              lda ScreenLeft_PageLoc
              adc #$00                  ;add carry to page location for leftScreenLeft_X_Pos
...
GameRoutines:
      ...
      .dw FlagpoleSlide ; no longer used
      .dw PlayerEndLevel ; no longer used
      .dw PlayerLoseLife
      .dw PlayerEntrance
...
.if SpeedMode == 1
      ...
      EntrMode2Cont:
            lda #$fd                  ;otherwise, set value here then execute sub
.else
...
SizeChk:    jsr PlayerMovementSubs      ;run movement subroutines
            ldy #PlayerSizeSmall                    ;is player small?
            lda PlayerSize
            bne ChkMoveDir
...
VerticalPipeEntry:
      .if SpeedMode == 1
            lda #$03             ;set 3 as movement amount ;hack for FAST
      .else
...
ProcMove:  jsr PlayerPhysicsSub      ;run sub related to jumping and swimming
            .if UseSelectStartsLevelTransition > 0
           jsr PressSelectToJumpNext
           .endif
...
MaxLeftXSpdData:
      .db 256-PlayerRunSpeed, 256-PlayerWalkSpeed, 256-PlayerSlowWalkSpeed

MaxRightXSpdData:
      .db PlayerRunSpeed, PlayerWalkSpeed, PlayerSlowWalkSpeed
...
ResGTCtrl: lda #$18                   ;reset game timer control
      ...
      .if ScoreReplacementMode == ScoreReplacementModeTime
        ...
        sta DigitModifier+5    ;sub 10 points from the player
        jsr AddToScore ;print status bar numbers based on nybbles, whatever they be
      .endif
...
NoJSChk: lda VerticalForce       ;dump vertical force 
         sta $00
         .if PlayerHasFastFall == 1
            lda SavedJoypadBits
            eor SavedJoypadBitsPrevious ; get changed bits
            and SavedJoypadBits ; just pressed only
            and #Down_Dir
            beq MovePlayerVerticallyNormal

            lda #$04
            sta Player_Y_Speed
            bne MovePlayerVerticallyFinish

            MovePlayerVerticallyNormal:
            lda #$04                ;set maximum vertical speed here
         .else
            lda #$04                ;set maximum vertical speed here
         .endif
MovePlayerVerticallyFinish:
...
SetMdMax: 
      .if UseFastBowserKill > 0
            lda #$08         ;set maximum speed in A
      .else
...
ProcessEnemyData:
        lda ScreenRight_PageLoc
        cmp #$F0
        bcs ProcessEnemyDataSkip ; Skip enemy loading if really high page number
...
SetM2: lda #Silence              ;silence music
      ...
      cmp #$07
      beq SetM2Final
      ; New Bowser subroutine: let's move back into gameplay instead
      lda #GameModeValue
      sta OperMode
      lda #$03
      sta OperMode_Task
...
RemoveBridge:
         ...
         .if UseFastBowserKill > 0
            lda #$08 ; launch that bowser downwards
         .else
            lda #$00
         .endif
          sta Enemy_Y_Speed,x         ;and movement force
...
Shroom_Flower_PUp:
      ...
      beq UpToSuper
      cmp #PlayerStatusSuper            ;if player status not super, leave
      bne NoPUp
      ldx ObjectOffset    ;get enemy offset, not necessary
      lda #PlayerStatusFire            ;set player status to fiery
      sta PlayerStatus
...
AreaChangeTimerData:
      .db ChangeAreaTimerMaxSlow, ChangeAreaTimerMaxMed
     ; .db $a0, $34
...
FPS2nd:   ldy #$bc               ;the slide sound shares part of third part
